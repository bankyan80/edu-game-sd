...
import { Star, Play, Heart, Users } from "lucide-react";
...
export default function GameCard({ game, index = 0 }: { game: Game; index?: number }) {
  ...
  return (
    <Link href={`/games/${game.slug}`} onClick={() => audioManager.playClick()}>
      <motion.div
      ...
      >
        ...
        <div className="p-4">
          ...
          {/* Play button */}
          <div className="flex items-center justify-center gap-1.5 py-2.5 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-2xl text-xs font-bold shadow-md group-hover:shadow-lg transition-all ripple-container">
