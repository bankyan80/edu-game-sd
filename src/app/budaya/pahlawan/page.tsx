      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative z-10">
        ...
        <div className="glass-strong rounded-3xl p-6 mb-8 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Pahlawan Nasional 🏛️</h1>
              <p className="text-gray-500 text-sm">Tokoh pejuang kemerdekaan dan pembangunan bangsa Indonesia</p>
            </div>
          </div>
        </div>
