...
const subTopics = [
  { name: "Indonesia Raya", detail: "Cipt: Wage Rudolf Supratman", emoji: "🎼" },
  { name: "Berkibarlah Benderaku", detail: "Cipt: Ibu Sud", emoji: "🇮🇩" },
  { name: "Tanah Airku", detail: "Cipt: Ibu Sud", emoji: "🌅" },
  { name: "Bagimu Negeri", detail: "Cipt: Ki Hajar Dewantara & Wingit Suryani", emoji: "🎶" },
  { name: "Satu Nusa Satu Bangsa", detail: "Cipt: Liberty Manik", emoji: "🏔️" },
  { name: "Rayuan Pulau Kelapa", detail: "Cipt: Ismail Marzuki", emoji: "🌴" },
];
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative z-10">
        ...
        <div className="glass-strong rounded-3xl p-6 mb-8 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Lagu Nasional 🎵</h1>
              <p className="text-gray-500 text-sm">Lagu kebangsaan dan lagu wajib nasional Indonesia</p>
            </div>
          </div>
        </div>
