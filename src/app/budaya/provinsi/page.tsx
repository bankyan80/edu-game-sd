...
const subTopics = [
  { name: "Aceh", detail: "Pulau: Sumatera", emoji: "🏠" },
  { name: "Sumatera Utara", detail: "Pulau: Sumatera", emoji: "🗺️" },
  { name: "Sumatera Barat", detail: "Pulau: Sumatera", emoji: "🗺️" },
  { name: "Riau", detail: "Pulau: Sumatera", emoji: "🗺️" },
  { name: "Jambi", detail: "Pulau: Sumatera", emoji: "🗺️" },
  { name: "Sumatera Selatan", detail: "Pulau: Sumatera", emoji: "🗺️" },
];
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="relative z-10">
        ...
        <div className="glass-strong rounded-3xl p-6 mb-8 shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Provinsi Indonesia 🏝️</h1>
              <p className="text-gray-500 text-sm">Keberagaman suku, bahasa, dan budaya dari setiap provinsi</p>
            </div>
          </div>
        </div>
